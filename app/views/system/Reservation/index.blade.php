...
<div id="content" class="col-lg-10 col-sm-11">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="box">
                <div class="box-header">
                    <h2><i class="fa fa-check"></i>List Of Reservations</h2>
                    <div class="box-icon">
                ...
                <div class="box-content clearfix">
                    <div class="row" id="reservation_list">
                        @include("system.Reservation.list")
                    </div>
        ...
        <div class="col-sm-4">
            <div class="box">
                <div class="box-header">
                    <h2><i class="fa fa-check"></i><span id="form_title">Add Reservation</span></h2>
                    <div class="box-icon">
                        <a href="ui-nestable-list.html#" class="btn-setting"><i class="fa fa-wrench"></i></a>
                        <a href="ui-nestable-list.html#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
                        <a href="ui-nestable-list.html#" class="btn-close"><i class="fa fa-times"></i></a>
                ...
                <div class="box-content clearfix" id="reservation_add">
                    @include("system.Reservation.add")
                </div>
