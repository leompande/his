    ...
    <div class="col-lg-5 col-md-5">
        ...
        <div class="box noOverflow chat alt">
            ...
            <div class="contacts">
                <ul class="list">
                    <li>
                        <img class="avatar" src="system/assets/img/avatar.jpg" alt="avatar">
                        <span class="name">Łukasz Holeczek</span>
                        <span class="status online"></span>
                        <span class="important">4</span>
                    </li>
                    <li>
                        <img class="avatar" src="system/assets/img/avatar2.jpg" alt="avatar">
                        <span class="name">Łukasz Holeczek</span>
                        <span class="status offline"></span>
                    </li>
                    <li>
                        <img class="avatar" src="system/assets/img/avatar3.jpg" alt="avatar">
                        <span class="name">Łukasz Holeczek</span>
            ...
            <div class="conversation">
                <div class="actions">
                    <img class="avatar" src="system/assets/img/avatar.jpg" alt="avatar">
                    <img class="avatar" src="system/assets/img/avatar3.jpg" alt="avatar">
                    <img class="avatar" src="system/assets/img/avatar4.jpg" alt="avatar">
                </div>
                <ul class="talk">
                    <li>
                        <img class="avatar" src="system/assets/img/avatar3.jpg" alt="avatar">
...
<div class="row">
    ...
    <div class="col-lg-12 discussions">
        ...
        <ul>
            ...
            <li>
                <div class="author">
                    <img src="system/assets/img/avatar.jpg" alt="avatar">
                </div>
                ...
                <ul>
                    ...
                    <li>
                        <div class="author">
                            <img src="system/assets/img/avatar3.jpg" alt="avatar">
                        </div>
                    ...
                    <li>
                        <div class="author">
                            <img src="system/assets/img/avatar6.jpg" alt="avatar">
                        </div>
            ...
            <li>
                <div class="author">
                    <img src="system/assets/img/avatar9.jpg" alt="avatar">
                </div>
                ...
                <ul>
                    ...
                    <li>
                        <div class="author">
                            <img src="system/assets/img/avatar2.jpg" alt="avatar">
                        </div>
                    ...
                    <li>
                        <div class="author">
                            <img src="system/assets/img/avatar4.jpg" alt="avatar">
                        </div>
